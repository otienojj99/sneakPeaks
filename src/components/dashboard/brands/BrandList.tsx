...
interface BrandListProps {
  ...
  onUpdateFilters: (filters: Partial<BrandFilters>) => void;
  onRefresh: () => void;
...
const BrandList = ({
  ...
  const toggleSelectAll = () => {
    if (selectedIds.length === brands.length) {
      ...
      setSelectedIds(brands.map((c) => c.id));
    }
  };
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <div className="bg-white rounded-xl border border-gray-200 p-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="text-2xl font-bold text-gray-900">
                {brands.filter((c) => c.is_active).length}
              </p>
        ...
        <div className="bg-white rounded-xl border border-gray-200 p-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="text-2xl font-bold text-gray-900">
                {brands.filter((c) => !c.sort_order).length}
              </p>
        ...
        <div className="bg-white rounded-xl border border-gray-200 p-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="text-2xl font-bold text-gray-900">
                {brands.reduce((sum, c) => sum + (c.id || 0), 0)}
              </p>
                  ...
                  {brands.map((brand) => (
                    <tr
                      ...
                      className={`group hover:bg-gray-50/80 transition-colors ${
                        selectedIds.includes(brand.id) ? "bg-emerald-50/40" : ""
                      }`}
                    >
                      {/* Checkbox */}
                        ...
                        >
                          <span
                            className={`w-1.5 h-1.5 rounded-full ${
                              brand.is_active ? "bg-emerald-500" : "bg-gray-400"
                            }`}
                          />
                      ...
                      <td className="py-3.5 px-4 text-right">
                        <div className="relative inline-block">
                          <button
                            onClick={() =>
                              setOpenActionId(
                                openActionId === brand.id ? null : brand.id,
                              )
                            }
